...
import com.lzh.mdzhihudaily_mvp.widget.CustomTextSliderView;
 ...
 * @author lzh
 * @desc:
 * @date Created on 2017/3/5 17:05
...
public class NewsListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private void bindItemView(ItemViewHolder viewHolder, int position, boolean isDateView) {
        ...
        if (isDateView) {
            ((DateViewHolder) viewHolder).newsDate.setText(story.getStoryDate());
        }
    ...
    static class DateViewHolder extends ItemViewHolder {
